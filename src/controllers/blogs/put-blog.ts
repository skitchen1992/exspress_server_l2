...
import { PostBlogSchemaResponse, PutBlogSchema, ResponseErrorSchema } from '../../models';
...
export const putBlogController = async (req: RequestType, res: Response<ResponseType>) => {
  try {
